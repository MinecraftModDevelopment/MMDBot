...
public abstract class PaginatedCommand extends SlashCommand {
    ...
    /**
     * If {@code true}, messages generated by the command have a dismiss button.
     */
    protected boolean dismissibleMessage;
    ...
    private ItemComponent[] createScrollButtons(String id, int start, int maximum) {
        ...
        if (dismissibleMessage) {
            return new ItemComponent[]{
                backward, forward, DismissListener.createDismissButton()
            };
        }
