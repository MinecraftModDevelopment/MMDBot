...
public final class MMDBot {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            final var commandListener = new CommandClientBuilder().setOwnerId(MMDBot.config.getOwnerID())
                    .setPrefix(MMDBot.config.getMainPrefix()).setAlternativePrefix(MMDBot.config.getAlternativePrefix())
                    .addCommand(new CmdGuild()).addCommand(new CmdBuild()).addCommand(new CmdMe())
                    .addCommand(new CmdUser()).addCommand(new CmdRoles()).addCommand(new CmdJustAsk())
                    .addCommand(new CmdPaste()).addCommand(new CmdXy()).addCommand(new CmdReadme())
                    .addCommand(new CmdRules()).addCommand(new CmdCatFacts())
                    ...
                    .addCommand(new CmdEventsHelp()).addCommand(new CmdToggleMcServerPings())
                    .addCommand(new CmdToggleEventPings()).addCommand(new CmdForgeVersion())
                    .addCommand(new CmdMinecraftVersion()).addCommand(new CmdFabricVersion()).addCommand(new CmdMute())
                    .addCommand(new CmdUnmute()).addCommand(new CmdCommunityChannel()).addCommand(new CmdGreatMoves())
                    .setHelpWord("help").build();
