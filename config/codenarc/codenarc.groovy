ruleset{
    ...
    description'''
        A Sample Groovy RuleSet containing all Code Narc Rules, grouped by category.
    ...
    // rulesets/size.xml
    AbcMetric  // RequirestheGMetricsjar
    ClassSize
    CrapMetric  // RequirestheGMetricsjarandaCoberturacoveragefile
    CyclomaticComplexity  // RequirestheGMetricsjar
    MethodCount
    MethodSize
    NestedBlockDepth
    ParameterCount
